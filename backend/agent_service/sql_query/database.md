...
| 字段名        | 类型         | 约束                                                         | 说明                                    |
| ------------- | ------------ | ------------------------------------------------------------ | --------------------------------------- |
| id            | BIGINT       | PRIMARY KEY                                                  | 教师唯一工号（手动分配，非自增）        |
...
| 字段名            | 类型         | 约束                                                         | 说明                               |
| ----------------- | ------------ | ------------------------------------------------------------ | ---------------------------------- |
| id                | BIGINT       | PRIMARY KEY                                                  | 秘书唯一工号（手动分配，非自增）   |
...
| 字段名      | 类型         | 约束                                                         | 说明                           |
| ----------- | ------------ | ------------------------------------------------------------ | ------------------------------ |
| id          | BIGINT       | PRIMARY KEY, AUTO_INCREMENT                                  | 模板唯一 ID                    |
...
# 5. template_form_field（模板表字段）

## 字段设计

| 字段名          | 类型         | 约束                                                         | 说明                                                                 |
| --------------- | ------------ | ------------------------------------------------------------ | -------------------------------------------------------------------- |
| id              | BIGINT       | PRIMARY KEY, AUTO_INCREMENT                                  | 字段唯一 ID                                                          |
...
- CHECK(deadline > started_time OR deadline IS NULL OR started_time IS NULL)
...
# 12. collect_task_target（收集任务目标教师表）
...
# 13. field_validation_record（字段校验记录表）
...
- UNIQUE(aggregation_id, teacher_id, field_name)
